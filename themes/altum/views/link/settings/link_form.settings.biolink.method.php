...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="d-flex justify-content-between">
        <span class="h4"><?= $this->language->link->links->settings ?></span>
    </div>
    ...
    <div class="custom-control custom-switch">
        <input id="schedule_<?= $row->link_id ?>" name="schedule" type="checkbox" class="custom-control-input" <?= !empty($row->start_date) && !empty($row->end_date) ? 'checked="checked"' : null ?>>
    ...
    <div class="row mt-3 schedule_container" style="display: none;">
        <div class="col">
            <div class="form-group">
