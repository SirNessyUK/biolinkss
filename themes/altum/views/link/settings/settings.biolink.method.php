    ...
    <div class="col-12 col-md-6">
        ...
        <div class="d-flex justify-content-between">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="settings-tab" data-toggle="pill" href="#settings" role="tab" aria-controls="settings" aria-selected="true"><?= $this->language->link->header->settings_tab ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="links-tab" data-toggle="pill" href="#links" role="tab" aria-controls="links" aria-selected="false"><?= $this->language->link->header->links_tab ?></a>
                </li>
            </ul>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a href="#" class="dropdown-item" data-toggle="modal" data-target="#create_biolink_link">
                        <i class="fa fa-circle fa-sm" style="color: <?= $this->language->link->biolink->link->color ?>"></i>

                        <?= $this->language->link->biolink->link->name ?>
                    </a>

                    <a href="#" class="dropdown-item" data-toggle="modal" data-target="#create_biolink_twitch">
                        <i class="fa fa-circle fa-sm" style="color: <?= $this->language->link->biolink->twitch->color ?>"></i>

                        <?= $this->language->link->biolink->twitch->name ?>
                    </a>

                    <a href="#" class="dropdown-item" data-toggle="modal" data-target="#create_biolink_youtube">
                        <i class="fa fa-circle fa-sm" style="color: <?= $this->language->link->biolink->youtube->color ?>"></i>

                        <?= $this->language->link->biolink->youtube->name ?>
                    </a>

                    <a href="#" class="dropdown-item" data-toggle="modal" data-target="#create_biolink_soundcloud">
                        <i class="fa fa-circle fa-sm" style="color: <?= $this->language->link->biolink->soundcloud->color ?>"></i>

                        <?= $this->language->link->biolink->soundcloud->name ?>
                    </a>

                    <a href="#" class="dropdown-item" data-toggle="modal" data-target="#create_biolink_vimeo">
                        <i class="fa fa-circle fa-sm" style="color: <?= $this->language->link->biolink->vimeo->color ?>"></i>

                        <?= $this->language->link->biolink->vimeo->name ?>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="biolink-preview-container">
            <div class="biolink-preview">
                <div class="biolink-preview-iframe-container">
                    <iframe id="biolink_preview_iframe" class="biolink-preview-iframe container-disabled-simple" src="<?= url($data->link->url . '?preview') ?>"></iframe>
                </div>
            </div>
        </div>
    </div>
