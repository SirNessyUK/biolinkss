    ...
    <div class="card-body">
        ...
        <form name="update_link" action="" method="post" role="form">
            ...
            <div class="custom-control custom-switch">
                <input id="schedule" name="schedule" type="checkbox" class="custom-control-input" <?= !empty($data->link->start_date) && !empty($data->link->end_date) ? 'checked="checked"' : null ?>>
            ...
            <div id="schedule_container" class="row mt-3" style="display: none;">
                <div class="col">
                    <div class="form-group">
