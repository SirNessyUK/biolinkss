    ...
    <div class="container">
        ...
        <div class="d-flex align-items-center">
            ...
            <p class="text-muted mb-0">
                <?= sprintf($this->language->link->header->subheader, '<strong><a href="' . url($data->link->url) . '" target="_blank">' . url($data->link->url) . '</a></strong>') ?>
                ...
                <button
                        ...
                        data-clipboard-text="<?= url($data->link->url) ?>"
                >
