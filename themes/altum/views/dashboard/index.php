        ...
        <div class="row justify-content-between">
            ...
            <div class="col-6 col-md-3 mb-5 mb-md-0">
                <div class="card border-0 bg-gradient-info text-white h-100 zoomer">
                    <div class="card-body">
                        <div class="card-title h4 mb-3"><?= $data->links_total ?> <i class="fa fa-link fa-xs"></i></div>
            ...
            <div class="col-6 col-md-3 mb-5 mb-md-0">
                <div class="card border-0 bg-gradient-warning text-white h-100 zoomer">
                    <div class="card-body">
                        <div class="card-title h4 mb-3"><?= $data->links_clicks_total ?> <i class="fa fa-chart-line fa-xs"></i></div>
            ...
            <table class="table table-custom">
                ...
                <?php while($row = $data->projects_result->fetch_object()): ?>
                    ...
                    <tr>
                        ...
                        <td class="text-muted clickable" data-href="<?= url('project/' . $row->project_id) ?>"><span><?= \Altum\Date::get($row->date) ?></span></td>
                        <td>
                            <div class="dropdown">
