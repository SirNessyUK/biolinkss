...
<header class="header">
    <div class="container">
        ...
        <div class="d-flex justify-content-between">
            <h1><?= $this->language->account->header->header ?></h1>
...
<section class="container">
    ...
    <?php if($this->user->package_id != 'free'): ?>
        <p class="text-muted">
            ...
            <?php if($this->user->payment_subscription_id): ?>
                ( <a href="<?= url('account/cancelsubscription' . \Altum\Middlewares\Csrf::getUrlQuery()) ?>" class="text-muted"><?= $this->language->account->package->cancel_subscription ?></a> )
            <?php endif ?>
        </p>
    ...
    <div class="margin-top-6 d-flex justify-content-between align-items-center">
        ...
        <a href="<?= url('account/delete' . \Altum\Middlewares\Csrf::getUrlQuery()) ?>" class="btn btn-danger" data-confirm="<?= $this->language->global->info_message->confirm_delete ?>"><?= $this->language->global->delete ?></a>
    </div>
