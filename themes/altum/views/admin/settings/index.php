...
<div class="row mt-5">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="main">
                            <div class="form-group">
                                <label><i class="fa fa-heading"></i> <?= $this->language->admin_settings->main->title ?></label>
                                <input type="text" name="title" class="form-control" value="<?= $this->settings->title ?>" />
                            </div>

                            <div class="form-group">
                                <label><i class="fa fa-language"></i> <?= $this->language->admin_settings->main->default_language ?></label>
                            ...
                            <div class="form-group">
                                <label><i class="fa fa-eye"></i> <?= $this->language->admin_settings->main->logo ?></label>
                                <?php if($this->settings->logo != ''): ?>
                                    <div class="m-1">
                                        <img src="<?= url(UPLOADS_URL_PATH . 'logo/' . $this->settings->logo) ?>" class="img-fluid" />
                                    </div>
                                <?php endif ?>
                                ...
                                <small class="text-muted"><a href="admin/settings/removelogo<?= \Altum\Middlewares\Csrf::getUrlQuery() ?>"><?= $this->language->admin_settings->main->logo_remove ?></a></small>
                            </div>

                            <div class="form-group">
                                <label><i class="fa fa-icons"></i> <?= $this->language->admin_settings->main->favicon ?></label>
                                ...
                                <small class="text-muted"><a href="admin/settings/removefavicon<?= \Altum\Middlewares\Csrf::getUrlQuery() ?>"><?= $this->language->admin_settings->main->favicon_remove ?></a></small>
                            </div>

                            <div class="form-group">
                                <label><i class="fa fa-atlas"></i> <?= $this->language->admin_settings->main->time_zone ?></label>
                            ...
                            <div class="form-group">
                                <label><i class="fa fa-envelope"></i> <?= $this->language->admin_settings->main->email_confirmation ?></label>
                            ...
                            <div class="form-group">
                                <label><i class="fa fa-users"></i> <?= $this->language->admin_settings->main->register_is_enabled ?></label>
                            ...
                            <div class="form-group">
                                <label><i class="fa fa-sitemap"></i> <?= $this->language->admin_settings->main->index_url ?></label>
                            ...
                            <div class="form-group">
                                <label><i class="fa fa-file-word"></i> <?= $this->language->admin_settings->main->terms_and_conditions_url ?></label>
                            ...
                            <div class="form-group">
                                <label><i class="fa fa-file-word"></i> <?= $this->language->admin_settings->main->privacy_policy_url ?></label>
                        ...
                        <div class="tab-pane fade" id="payment">
                            <div class="form-group">
                                <label><i class="fa fa-copyright"></i> <?= $this->language->admin_settings->payment->brand_name ?></label>
                            ...
                            <div class="form-group">
                                <label><i class="fa fa-coins"></i> <?= $this->language->admin_settings->payment->currency ?></label>
                            ...
                            <h4><i class="fab fa-paypal icon-paypal"></i> <?= $this->language->admin_settings->payment->paypal ?></h4>
                            ...
                            <h4><i class="fab fa-stripe icon-stripe"></i> <?= $this->language->admin_settings->payment->stripe ?></h4>
                        ...
                        <div class="tab-pane fade" id="captcha">
                            <h4><i class="fab fa-google"></i> <?= $this->language->admin_settings->captcha->recaptcha ?></h4>
                        ...
                        <div class="tab-pane fade" id="socials">
                            ...
                            <div class="form-group">
                                <label><i class="fab fa-facebook"></i> <?= $this->language->admin_settings->socials->facebook ?></label>
                                <input type="text" name="socials_facebook" class="form-control" value="<?= $this->settings->socials->facebook ?>" />
                            </div>

                            <div class="form-group">
                                <label><i class="fab fa-twitter"></i> <?= $this->language->admin_settings->socials->twitter ?></label>
                                <input type="text" name="socials_twitter" class="form-control" value="<?= $this->settings->socials->twitter ?>" />
                            </div>

                            <div class="form-group">
                                <label><i class="fab fa-youtube"></i> <?= $this->language->admin_settings->socials->youtube ?></label>
                                <input type="text" name="socials_youtube" class="form-control" value="<?= $this->settings->socials->youtube ?>" />
                            </div>

                            <div class="form-group">
                                <label><i class="fab fa-instagram"></i> <?= $this->language->admin_settings->socials->instagram ?></label>
                        ...
                        <div class="tab-pane fade" id="smtp">
                            ...
                            <div class="">
                                <a href="admin/settings/testemail<?= \Altum\Middlewares\Csrf::getUrlQuery() ?>" class="btn btn-info"><?= $this->language->admin_settings->button->test_email ?></a>
                        ...
                        <div class="tab-pane fade" id="custom">
                            <div class="form-group">
                                <label><i class="fab fa-js"></i> <?= $this->language->admin_settings->custom->head_js ?></label>
                            ...
                            <div class="form-group">
                                <label><i class="fab fa-css3"></i> <?= $this->language->admin_settings->custom->head_css ?></label>
                        ...
                        <div class="tab-pane fade" id="email_templates">
                            ...
                            <h4><?= $this->language->admin_settings->email_templates->activation ?></h4>

                            <div class="form-group">
                                <label><?= $this->language->admin_settings->email_templates->subject ?></label>
                                <input type="text" class="form-control" name="email_templates_activation_subject" value="<?= $this->settings->email_templates->activation_subject ?>" />

                                <small class="form-text text-muted"><?= $this->language->admin_settings->email_templates_keys->name ?></small>
                                <small class="form-text text-muted"><?= $this->language->admin_settings->email_templates_keys->website_title ?></small>

                            </div>

                            <div class="form-group">
                                <label><?= $this->language->admin_settings->email_templates->body ?></label>
                                <textarea class="form-control" name="email_templates_activation_body" rows="5"><?= $this->settings->email_templates->activation_body ?></textarea>

                                <small class="form-text text-muted"><?= $this->language->admin_settings->email_templates_keys->name ?></small>
                                <small class="form-text text-muted"><?= $this->language->admin_settings->email_templates_keys->website_title ?></small>
                                <small class="form-text text-muted"><?= $this->language->admin_settings->email_templates_keys->activation_link ?></small>

                            </div>

                            <hr class="my-3"/>

                            <h4><?= $this->language->admin_settings->email_templates->lost_password ?></h4>

                            <div class="form-group">
                                <label><?= $this->language->admin_settings->email_templates->subject ?></label>
                                <input type="text" class="form-control" name="email_templates_lost_password_subject" value="<?= $this->settings->email_templates->lost_password_subject ?>" />
                            ...
                            <div class="form-group">
                                <label><?= $this->language->admin_settings->email_templates->body ?></label>
                                <textarea class="form-control" name="email_templates_lost_password_body" rows="5"><?= $this->settings->email_templates->lost_password_body ?></textarea>

                                <small class="form-text text-muted"><?= $this->language->admin_settings->email_templates_keys->name ?></small>
                                <small class="form-text text-muted"><?= $this->language->admin_settings->email_templates_keys->website_title ?></small>
                                <small class="form-text text-muted"><?= $this->language->admin_settings->email_templates_keys->lost_password_link ?></small>
    ...
    <div class="mb-5 mb-lg-0 col-12 col-lg-3 order-0 order-lg-1">
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link" href="#email_templates" data-toggle="pill" role="tab"><i class="fa fa-envelope-open"></i> <?= $this->language->admin_settings->tab->email_templates ?></a>
