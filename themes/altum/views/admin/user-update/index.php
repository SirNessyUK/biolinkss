        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="custom-select" name="package_id">
                    <option value="free" <?php if($data->user->package_id == 'free') echo 'selected' ?>><?= $this->settings->package_free->name ?></option>
                    <option value="trial" <?php if($data->user->package_id == 'trial') echo 'selected' ?>><?= $this->settings->package_trial->name ?></option>
                    <option value="custom" <?php if($data->user->package_id == 'custom') echo 'selected' ?>><?= $this->settings->package_custom->name ?></option>

                    <?php while($row = $data->packages_result->fetch_object()): ?>
                        <option value="<?= $row->package_id ?>" <?php if($data->user->package_id == $row->package_id) echo 'selected' ?>><?= $row->name ?></option>
                    <?php endwhile ?>
                </select>
            </div>
