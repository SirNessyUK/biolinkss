            ...
            <div class="modal-body">
                <form name="create_link" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label><i class="fa fa-signature"></i> <?= $this->language->create_link_modal->input->location_url ?></label>
                    ...
                    <div class="form-group">
                        <label><i class="fa fa-link"></i> <?= $this->language->create_link_modal->input->url ?></label>
