                ...
                <div class="dropdown">
                    <a href="#" data-toggle="dropdown" class="text-secondary dropdown-toggle dropdown-toggle-simple">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" data-confirm="' . \Altum\Language::get()->global->info_message->confirm_delete . '" href="admin/users/delete/' . $target_id . \Altum\Middlewares\Csrf::getUrlQuery() . '"><i class="fa fa-times"></i> ' . \Altum\Language::get()->global->delete . '</a>
                        </div>
                    </a>
                </div>';
                ...
                <div class="dropdown">
                    <a href="#" data-toggle="dropdown" class="text-secondary dropdown-toggle dropdown-toggle-simple">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" data-confirm="' . \Altum\Language::get()->global->info_message->confirm_delete . '" href="admin/pages/delete/' . $target_id . \Altum\Middlewares\Csrf::getUrlQuery() . '"><i class="fa fa-times"></i> ' . \Altum\Language::get()->global->delete . '</a>
                        </div>
                    </a>
                </div>';
                    ...
                    <a href="#" data-toggle="dropdown" class="text-secondary dropdown-toggle dropdown-toggle-simple">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            ' . (is_numeric($target_id) ?
                                '<a class="dropdown-item" data-confirm="' . \Altum\Language::get()->global->info_message->confirm_delete . '" href="admin/packages/delete/' . $target_id . \Altum\Middlewares\Csrf::getUrlQuery() . '"><i class="fa fa-times"></i> ' . \Altum\Language::get()->global->delete . '</a>'
                                : null) . '
