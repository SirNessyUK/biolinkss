...
class Captcha {
    ...
    public function display() {
        ...
        if($this->recaptcha) {
            ...
            echo '<img src="' . $this->captcha_location . '" id="captcha" alt="' . Language::get()->global->accessibility->captcha_alt . '" /><input type="text" name="captcha" class="form-control form-control-border" aria-label="' . Language::get()->global->accessibility->captcha_input . '" required="required" autocomplete="off"/>';
        }
